              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: () {
                        String dateFormat = DateUtility().changeDateFormat(
                            controller.selectedDate.toString(),
                            'dd/MM/yyyy'); // 2024-05-11 convert to 11 May 2024
                        print(
...
class SignUpController extends GetxController {
  ...
  Future<void> signUp(
    ...
    var res = await restService.createUser(
      name: fullName,
      email: email,
      phone_number: phone,
      gender: gender,
